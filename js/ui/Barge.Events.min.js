Barge.Events.js:300: WARNING - Misplaced function annotation. This JSDoc is not attached to a function node. Are you missing parentheses?
                                                      return Barge.Event.EventElement.element === element;
                                                      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

0 error(s), 1 warning(s)
var Barge=Barge||{};
(function(g,h,k){Barge.Event=Barge.Event||{};Barge.Event.getEvent=function(a){return window.event?window.event:a};Barge.Event.getEventTarget=function(a){a=Barge.Event.getEvent(a);return a.target?a.target:a.srcElement};Barge.Event.EventElement=function(a){this.element=a;this.events={}};Barge.Event.EventElement.prototype.addEvent=function(a,d,c,b){a&&(a.addEventListener?a.addEventListener(d,c,b||!1):a.attachEvent&&a.attachEvent("on"+d,c))};Barge.Event.EventElement.prototype.removeEvent=function(a,d,
c,b){a.removeEventListener?a.removeEventListener(d,c,void 0===b?!1:b):a.detachEvent?a.detachEvent("on"+d,c):a["on"+d]=null};Barge.Event.EventElement.prototype.bind=function(a,d,c){c=void 0===c?!1:c;g.defined(this.events[a])||(this.events[a]=[]);this.events[a].push(d);this.addEvent(this.element,a,d,c)};Barge.Event.EventElement.prototype.unbind=function(a,d,c){c=void 0===c?!1:c;var b=g.defined(d);a in this.events&&(this.events[a]=this.events[a].filter(function(e){if(b&&e!==d)return!0;this.removeEvent(this.element,
